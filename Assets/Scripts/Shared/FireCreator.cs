...
// Builds the fire, smoke, and spark particle effects in code when the scene loads.
// Attach this to any GameObject and assign the three materials in the Inspector.
public class FireCreator : MonoBehaviour
{
    ...
    void CreateFire()
    {
        ...
        // Colour shifts from yellow to deep red over the particle's lifetime
        ...
        // Particles grow then shrink as they rise
        ...
        // Noise makes the fire look more natural and flickery
        var noise = ps.noise;
        noise.enabled     = true;
        noise.strength    = 0.5f;
    ...
    void CreateSmoke()
    {
        ...
        // Smoke fades from grey to dark as it rises
        var colorOverLifetime = ps.colorOverLifetime;
        colorOverLifetime.enabled = true;
        Gradient gradient = new Gradient();
        gradient.SetKeys(
    ...
    void CreateSparks()
    {
        ...
        // Sparks go from bright yellow-white to dark orange as they fade out
        var colorOverLifetime = ps.colorOverLifetime;
        colorOverLifetime.enabled = true;
        Gradient gradient = new Gradient();
        gradient.SetKeys(
