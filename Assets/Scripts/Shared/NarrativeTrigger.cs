...
// When the player walks into this trigger zone it shows a quick narrative message on screen.
// Only fires once per scene - by attaching it to a trigger collider and assign the text field.
