...
public class CaptionUI3 : MonoBehaviour
{
    ...
    void BuildCanvas()
    {
        // Plain white sprite so the Image actually renders
        Texture2D tex = new Texture2D(1, 1);
        tex.SetPixel(0, 0, Color.white);
        tex.Apply();
        Sprite white = Sprite.Create(tex, new Rect(0, 0, 1, 1), new Vector2(0.5f, 0.5f));

        // Canvas that sits on top of the game world
        ...
        // Dark panel anchored to the bottom of the screen
        ...
        // CanvasGroup for fading the panel in and out
